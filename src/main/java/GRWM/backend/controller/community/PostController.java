...
*/
    ...
    @GetMapping()
    public List<PostDto> showTimelinePostList(@AuthenticationPrincipal CustomUserDetails userDetails){
        return postService.showTimelinePostList(userDetails.getCommunityUserId());
    }
...
*/
    ...
    public List<PostDto> getUserPosts(@PathVariable Long communityId){
        return postService.getUserPosts(communityId);
    }
